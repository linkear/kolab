...
const tipoComunidadModelo = require('../modelos/tipoComunidad')
...
const tipoComunidad = tipoComunidadModelo(sequelize, Sequelize)
...
tipoComunidad.hasMany(comunidad)
comunidad.belongsTo(tipoComunidad)
